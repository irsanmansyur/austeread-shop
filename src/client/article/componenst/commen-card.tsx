...
export default function CommentCard({ setReplay }: Props) {
  return (
    <article className="p-2 sm:p-6 mb-2 sm:mb-6 text-base bg-white rounded-lg dark:bg-gray-900">
      ...
      <div className="flex items-center mt-4 space-x-4">
        <button type="button" className="flex items-center text-sm text-gray-500 hover:underline dark:text-gray-400" onClick={(e) => setReplay(true)}>
