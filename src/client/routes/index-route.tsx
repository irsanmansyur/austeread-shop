...
import PageOrderSummary from "@client/order/page-order-summary";
import PageCheckoutProduct from "@client/product/page-checkout";
import PageProductDetail from "@client/product/page-detail";
import PagePaymentDetail from "@client/product/page-payment-details";
import PageSearchProduct from "@client/product/page-search-product";
import PageSelectPayment from "@client/product/page-select-payment";
import SearchPage from "@client/search/search-page";
import PageAccount from "@client/user/page-account";
...
export const routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: <PageCheckoutProduct />,
      },
      {
        path: "/invoice/payment-details",
        element: <PagePaymentDetail />,
      },
      {
        path: "/checkout/select-payment",
        element: <PageSelectPayment />,
      },
      {
        path: "/user/account",
        element: <PageAccount />,
      ...
      {
        path: "/search/:search?",
        element: <PageSearchProduct />,
      },
      {
        path: "/order/summary/:idOrder",
        element: <PageOrderSummary />,
      },
      {
        path: "/news/:idArticle",
